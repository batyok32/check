...
export default function Page({ params }) {
    ...
    useEffect(() => {
        const confi = getHelpItemsConfi(id, loadMore, "seller");
    ...
    return (
        <div>
            <div className="container-xxl">
                <div className="row mx-0 mt-3 row-gap-3">
                    ...
                    <div className="col-md-10 px-1">
                        <div className="bg-white shadow-sm">
                            <div className="row row-cols-2 row-cols-md-4 mx-0 py-3 px-3">
